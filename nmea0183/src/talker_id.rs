...
mod tests {
    ...
    fn known_ids_round_trip() {
        let cases = [
            (TalkerId::AB, "AB"), (TalkerId::AD, "AD"), (TalkerId::AG, "AG"),
            (TalkerId::AI, "AI"), (TalkerId::AN, "AN"), (TalkerId::AP, "AP"),
            (TalkerId::AR, "AR"), (TalkerId::AT, "AT"), (TalkerId::AX, "AX"),
            (TalkerId::CD, "CD"), (TalkerId::CR, "CR"), (TalkerId::CS, "CS"),
            (TalkerId::CT, "CT"), (TalkerId::CV, "CV"), (TalkerId::CX, "CX"),
            (TalkerId::DE, "DE"), (TalkerId::DF, "DF"),
            (TalkerId::EC, "EC"), (TalkerId::EP, "EP"), (TalkerId::ER, "ER"),
            (TalkerId::GA, "GA"), (TalkerId::GB, "GB"), (TalkerId::BD, "BD"),
            (TalkerId::GI, "GI"), (TalkerId::GL, "GL"), (TalkerId::GN, "GN"),
            (TalkerId::GP, "GP"), (TalkerId::GQ, "GQ"),
            (TalkerId::HC, "HC"), (TalkerId::HE, "HE"), (TalkerId::HF, "HF"),
            (TalkerId::HN, "HN"),
            (TalkerId::II, "II"), (TalkerId::IN, "IN"),
            (TalkerId::LA, "LA"), (TalkerId::LC, "LC"), (TalkerId::MP, "MP"),
            (TalkerId::OM, "OM"), (TalkerId::TR, "TR"),
            (TalkerId::NL, "NL"), (TalkerId::RA, "RA"), (TalkerId::SA, "SA"),
            (TalkerId::SD, "SD"), (TalkerId::SN, "SN"), (TalkerId::SS, "SS"),
            (TalkerId::TI, "TI"),
            (TalkerId::U0, "U0"), (TalkerId::U1, "U1"), (TalkerId::U2, "U2"),
            (TalkerId::U3, "U3"), (TalkerId::U4, "U4"), (TalkerId::U5, "U5"),
            (TalkerId::U6, "U6"), (TalkerId::U7, "U7"), (TalkerId::U8, "U8"),
            (TalkerId::U9, "U9"),
            (TalkerId::VD, "VD"), (TalkerId::VM, "VM"), (TalkerId::VR, "VR"),
            (TalkerId::VW, "VW"),
            (TalkerId::WI, "WI"),
            (TalkerId::YC, "YC"), (TalkerId::YD, "YD"), (TalkerId::YF, "YF"),
            (TalkerId::YL, "YL"), (TalkerId::YP, "YP"), (TalkerId::YR, "YR"),
            (TalkerId::YS, "YS"), (TalkerId::YT, "YT"), (TalkerId::YV, "YV"),
            (TalkerId::YX, "YX"),
            (TalkerId::ZA, "ZA"), (TalkerId::ZC, "ZC"), (TalkerId::ZQ, "ZQ"),
        ];
